...
###  https://rstudio.cloud/spaces/73676/project/1350072
...
```{r}
head(subset(bass.dat, Increment > 2)) #extract values with growth > 2
```

```{r}
head(subset(bass.dat, YearClass == 1989)) #extract fish born in 1989
```
